            ...
            <div key={p.id} className="bg-white rounded-xl border p-3 flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap gap-1.5 items-center">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-xs ${p.roadCondition==='Not Passable'?'bg-red-600 text-white':p.roadCondition==='Difficult to Pass'?'bg-orange-500 text-white':p.roadCondition==='Cleared'?'bg-green-500 text-white':'bg-slate-200'}`}>{p.roadCondition}</span>
