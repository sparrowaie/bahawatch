...
class Api {
  ...
  static Future<Map> createPost({required String photoPath, required double lat, required double lng, double? exifLat, double? exifLng, String? roadName, String? roadCondition, String? severity, String? caption}) async {
